...
const SiteLinks = () => {
    ...
    return ( 
        ...
        <motion.div whileHover={{ width: '180px' }} onHoverStart={() => setHoverLinked(true)} onHoverEnd={() => setHoverLinked(false)} style={{ height: '75px', width: '75px', background: '#0072b1' }}>
        ...
        <motion.div whileHover={{ width: '180px' }} onHoverStart={() => setHoverGithub(true)} onHoverEnd={() => setHoverGithub(false)} style={{ height: '75px', width: '75px', border: 'solid', background: 'white', textAlign: 'right' }}>
